...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2023 at 02:14 PM
...
--
-- Stand-in structure for view `daftar_pasien`
...
(1, 'Reza Rahadian', NULL, '1987-03-05', 'Bogor', 'M', 'Actor', '2023-03-02 00:00:00'),
(2, 'Fedi Nuril', NULL, '1982-07-01', 'Jakarta', 'M', 'Actor', NULL),
(3, 'Nicholas Saputra Schubring', NULL, '1984-02-24', 'Jakarta', 'M', 'Actor', '2023-03-02 00:00:00'),
(4, 'Diandra Paramitha Sastrowardoyo', NULL, '1982-03-16', 'Jakarta', 'F', 'Actress', '2023-03-02 00:00:00'),
(5, 'Isyana Sarasvati', NULL, '1993-05-02', 'Bandung', 'F', 'Singer', '2023-03-02 13:53:40'),
(6, 'Yoshua Sudarso', NULL, '1989-04-12', 'Jakarta', 'M', 'Actor', '2023-03-02 13:53:40'),
(7, 'Arafah Rianti', NULL, '1997-09-02', 'Depok', 'F', 'Comedian', '2023-03-02 13:53:40'),
(8, 'G.M.A. Bintang Mahaputra', NULL, '1996-05-05', 'Jakarta', 'M', 'Comedian', '2023-03-02 13:53:40'),
(9, 'Aci Resti', NULL, '1997-08-12', 'Tangerang', 'F', 'Comedian', '2023-03-02 13:53:40'),
(10, 'Sissy Priscillia', NULL, '1985-04-05', 'Jakarta', 'F', 'Actress', '2023-03-02 13:53:40'),
(11, 'Dennis Adhiswara', NULL, '1982-09-14', 'Malang', 'M', 'Actor', '2023-03-26 00:00:00');
...
--
-- Structure for view `daftar_pasien`
--
DROP TABLE IF EXISTS `daftar_pasien`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `daftar_pasien`  AS SELECT `patients`.`id` AS `patient_id`, `patients`.`fullname` AS `Nama_Lengkap`, `patients`.`birth_date` AS `Tanggal_Lahir`, `patients`.`birth_place` AS `Tempat_Lahir`, `patients`.`sex` AS `Jenis_Kelamin`, `patients`.`occupation` AS `Pekerjaan`, `patients`.`entry_date` AS `Tanggal_Masuk`, `patients`.`nik` AS `NIK` FROM `patients` ;
